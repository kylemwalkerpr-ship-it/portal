...
> **Short on time or not feeling adventurous?** You might consider [hiring a professional](https://developers.google.com/search/docs/fundamentals/do-i-need-seo).
...
Before you actually do anything mentioned in this section, check if Google has already found your content (maybe you don't need to do anything!). Try searching on Google for your site with the [`site:` search operator](https://developers.google.com/search/docs/monitor-debug/search-operators/all-search-site). If you see results pointing to your site, you're in the index. For example, a search for [site:wikipedia.org](https://www.google.com/search?q=site%3Awikipedia.org) returns these results. If you don't see your site, check out the [technical requirements](https://developers.google.com/search/docs/essentials/technical) to make sure there's nothing technically preventing your site from showing in Google Search, and then come back here.

Google primarily finds pages through links from other pages it already crawled. In many cases, these are other websites that are linking to your pages. Other sites linking to you is something that happens naturally over time, and you can also encourage people to discover your content by [promoting your site](#promote-your-website).
...
- **Breadcrumb** — displayed in search results to show page hierarchy
- **Domain** — the root domain of your site
...
- Write descriptive text in the titles and description fields of a video (the title of a video is still a title, and so you can apply [the best practices for writing titles here](https://developers.google.com/search/docs/fundamentals/seo-starter-guide) too).
...
| **PageRank** | While [PageRank](https://developers.google.com/search/docs/appearance/ranking-systems-guide#link-analysis) uses links and is one of the fundamental algorithms at Google, there's much more to Google Search than just links. We have many ranking signals, and PageRank is just one of those. |
...
|---|---|
| [Google Search Central blog](https://developers.google.com/search/blog) | Get the latest information from our Google Search Central blog. You can find information about updates to Google Search, new Search Console features, and much more. |
