...
function DetailDrawer({ application, onClose, onDecide, decisionPending }) {
    ...
    <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 18, fontFamily: SANS, background: BG, minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        <div>
          ...
          <h1 style={{ fontFamily: SERIF, fontSize: 32, fontWeight: 600, color: TEXT, margin: 0, letterSpacing: '-.018em' }}>Attorney applications</h1>
          {stats && (
