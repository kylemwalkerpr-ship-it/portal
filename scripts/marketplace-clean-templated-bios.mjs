 ...
 *     facts only (name, credential/registration TYPE, jurisdiction, verified/
 *     on-file booleans, practice areas, languages, years, education).
 *     Bar/registration NUMBERS are NEVER narrative authoring facts — they are
 *     verification-only and belong solely on the controlled bio-card.
 *     Generic "registration on file" / "credential verified" language is OK.
 *     No default credential, no RCIC/MARA labelling not present in the record,
 *     no conversion of generic years into "immigration practice", no invented
 *     history or success rates, and uncertainty is preserved with wording like
 *     "on the record"/"listed". No claim that this task independently verified
 *     any fact.
...
// the PROFILE FIELDS the narrative draws on (name, credential TYPE, jurisdiction,
...
const NARRATIVES = { // keyed by profiles.full_name (recorded-fact prose only; no credential/registration numbers, no cities)
  ...
  'Ranbir Singh': { narrative: 'Ranbir Singh practises as an immigration consultant (registration on file). His work centres on work permits, family sponsorship, and legal consultation, with sixteen years of professional practice recorded.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  'Sukhjinder Sidhu': { narrative: 'Sukhjinder Sidhu practises as an immigration consultant (registration on file), focusing on permanent-residence pathways, work permits, and study permits, with eight years of professional practice noted.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  'Pardeep Goel': { narrative: 'Pardeep Goel practises as an immigration consultant (registration on file), with client work that centres on family sponsorship, permanent residence, and study permits. His background includes a Bachelor of Commerce, an MBA, and an immigration-practitioner course; he practises in English, Punjabi, and Hindi.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.languages','consultants.education'] },
  'Shirani Jenita Daniel': { narrative: 'Shirani Jenita Daniel practises as an immigration consultant (registration on file) with twelve years of professional practice on record, concentrating on permanent residence, study permits, and family sponsorship.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  'Riddhi Mayank Bhatt (register display: Riddhi Bhatt)': { narrative: 'Riddhi Mayank Bhatt, registered as Riddhi Bhatt, practises as an immigration consultant (registration on file) at three years of professional practice. Her on-file record includes a master’s and an immigration-consultant certification from CDI College; the focus areas are permanent residence, family sponsorship, and study permits.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience','consultants.education'] },
  'Amir Ardalan Ansari': { narrative: 'Amir Ardalan Ansari practises as an immigration consultant (registration on file). His listed focus covers permanent-residence pathways, study permits, and family sponsorship, with seven years of professional practice recorded.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  'Olukayode Adebogun': { narrative: 'Olukayode Adebogun practises as an immigration consultant (registration on file), with family sponsorship, work permits, and permanent residence at the centre of his work.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
  'Rami Khattouf': { narrative: 'Rami Khattouf practises as an immigration consultant (registration on file), working on family sponsorship, permanent residence, and work permits, and offering Arabic alongside English.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.languages'] },
  ...
  'Constantine Paxinos': { narrative: 'Constantine Paxinos practises as an immigration consultant (registration on file), concentrating on employer-sponsored work visas, partner and family visas, and refusal-appeal consultations, with twelve years of professional practice recorded.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  'Dikshit Soni': { narrative: 'Dikshit Soni practises as an immigration consultant (registration on file) whose fourteen-year record includes an MBA, an immigration-practitioner diploma from Herzing, and an IELTS-instructor certification. Family sponsorship, permanent residence, and work permits are his areas.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience','consultants.education'] },
  'Naomi Crisostomo': { narrative: 'Naomi Crisostomo practises as an immigration consultant (registration on file), with five years of professional practice and focus areas of work permits, permanent residence, and family sponsorship.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  'Ramandeep Sood': { narrative: 'Ramandeep Sood practises as an immigration consultant (registration on file) whose five-year record is centred on permanent residence, work permits, and family sponsorship.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  'Joanne Cabral Adorna': { narrative: 'Joanne Cabral Adorna practises as an immigration consultant (registration on file), with permanent-residence pathways, work permits, and legal consultation as her focus areas.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
  'Maurilio Amezcua': { narrative: 'Maurilio Amezcua practises as an immigration consultant (registration on file), whose work centres on work permits, permanent residence, and study permits.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
  'Danijela Stojanovic': { narrative: 'Danijela Stojanovic practises as an immigration consultant (registration on file), focused on family sponsorship, work permits, and citizenship, with fifteen years of professional practice recorded.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  'Nadia Elhowari': { narrative: 'Nadia Elhowari practises as an immigration consultant (registration on file), with twelve years of professional practice and a focus on family sponsorship, permanent residence, and work permits.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.years_experience'] },
  ...
  'Martine Lef\u00e8vre': { narrative: 'Martine Lef\u00e8vre practises as an immigration consultant (registration on file), with permanent-residence pathways, work permits, and family sponsorship at the centre of her work.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
  'Balihar Singh Baryah': { narrative: 'Balihar Singh Baryah practises as an immigration consultant (registration on file), focused on family sponsorship, work permits, and permanent residence.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
  'Muhammad Afzal': { narrative: 'Muhammad Afzal practises as an immigration consultant (registration on file), concentrating on permanent residence, work permits, and study permits.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
  'Hatem Abdo': { narrative: 'Hatem Abdo practises as an immigration consultant (registration on file), whose work covers legal consultation, document preparation, and permanent residence.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
  'Nana Hong': { narrative: 'Nana Hong practises as an immigration consultant (registration on file), with permanent residence, work permits, and document preparation as her focus.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
  'Sruthy Sanoop': { narrative: 'Sruthy Sanoop practises as an immigration consultant (registration on file), concentrating on study permits, work permits, and permanent residence. Her on-file record includes a graduate diploma in Immigration and Citizenship Law from Queen\u2019s University and a post-baccalaureate diploma from Cape Breton University.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties','consultants.education'] },
  'Olusegun Adepoju': { narrative: 'Olusegun Adepoju practises as an immigration consultant (registration on file), with document preparation and permanent residence as his listed scope.', sources: ['profiles.full_name','consultants.registration_verified','consultants.specialties'] },
