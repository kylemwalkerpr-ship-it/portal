...
1. PR checks: the six P5 suites (`p5-off-mission-dispositions`, `p5-site-health-protection`, `p5-noindex-orchestrator-truthfulness`, `p5-orphan-orchestrator-truthfulness`, `p5-keyword-planner-demand-boundary`, `p5-auto-run-demand-boundary`), full Jest where available, `tsc --noEmit`, and the repository's SEO guard.
