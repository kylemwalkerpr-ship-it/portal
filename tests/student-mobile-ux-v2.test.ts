...
describe('student mobile UX v2', () => {
  ...
  test('conversation list is a bounded iOS scroll owner and keeps the dock tail reachable', () => {
    ...
    expect(listCss).toContain('display: flex !important')
    expect(listCss).toContain('flex-direction: column !important')
    expect(listCss).toContain('flex: 1 1 0% !important')
    expect(listCss).toContain('height: 0 !important')
    expect(listCss).toContain('min-height: 0 !important')
    expect(listCss).toContain('overflow-y: auto !important')
    expect(listCss).toContain('touch-action: pan-y')
    expect(listCss).toContain('padding-bottom: var(--student-dock-v2-gap) !important')
    expect(listCss).toContain('scroll-padding-bottom: var(--student-dock-v2-clearance) !important')
