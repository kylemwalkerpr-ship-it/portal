...
export async function generatePayhipProductPdf(
  ...
  const disclaimer =
    'This is an independent preparation and organization resource. It is not an official government form. It is not legal advice or legal representation. It is not a guarantee of approval. Government forms, fees, eligibility rules, filing windows, documentary requirements, and procedures can change. Verify the current instructions that apply to your facts before filing.'
