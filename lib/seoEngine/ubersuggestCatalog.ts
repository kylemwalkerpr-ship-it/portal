...
export function ubersuggestSpendPlan(): UberSpendCall[] {
  ...
  return [
    { name: 'keyword_suggestions', layer: 'keyword', args: { keywords: uk.seeds, language: uk.language, locId: uk.locId } },
    { name: 'keyword_suggestions', layer: 'keyword', args: { keywords: us.seeds, language: us.language, locId: us.locId } },
    { name: 'keyword_suggestions', layer: 'keyword', args: { keywords: ca.seeds, language: ca.language, locId: ca.locId } },
    { name: 'keyword_suggestions', layer: 'keyword', args: { keywords: au.seeds, language: au.language, locId: au.locId } },
    { name: 'match_keywords', layer: 'keyword', args: { keywords: uk.seeds, language: uk.language, locId: uk.locId, limit: 40 } },
    { name: 'match_keywords', layer: 'keyword', args: { keywords: us.seeds, language: us.language, locId: us.locId, limit: 40 } },
    { name: 'google_suggestions', layer: 'keyword', args: { keywords: [uk.seeds[0], us.seeds[0], ca.seeds[0]], language: 'en', country: 'uk' } },
    { name: 'keyword_overview', layer: 'keyword', args: { keyword: uk.seeds[0], language: uk.language, locId: uk.locId } },
    { name: 'keyword_overview', layer: 'keyword', args: { keyword: us.seeds[0], language: us.language, locId: us.locId } },
    { name: 'content_ideas', layer: 'content', args: { keywords: [uk.seeds[0], us.seeds[1]], language: 'en', locId: uk.locId } },
    { name: 'domain_overview', layer: 'domain', args: { domain: owned, language: 'en', locId: us.locId } },
    { name: 'domain_keywords', layer: 'domain', args: { domain: owned, language: 'en', locId: us.locId, limit: 50 } },
    { name: 'domain_top_pages', layer: 'domain', args: { domain: owned, language: 'en', locId: us.locId, limit: 20 } },
    { name: 'serp_analysis', layer: 'serp', args: { keyword: uk.seeds[0], language: uk.language, locId: uk.locId, limit: 10 } },
