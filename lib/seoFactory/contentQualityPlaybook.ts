...
export const CONTENT_QUALITY_PLAYBOOK: readonly GateDefinition[] = [
  ...
  def({
    ...
    promptInstruction: 'Write the missing section(s) named in the finding as natural prose for the reader — each must satisfy its outline purpose. Insert before the FAQ (or at the end). Never paste keyword strings.',
