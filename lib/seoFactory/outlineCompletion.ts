...
Write 120-280 words of plain, well-structured prose that completes this section's purpose and flows from the article above. Open with a bridge from the last claim — not a restatement of the thesis and not a fresh explainer. Mix short and medium sentences. Use the article's existing headings/voice. No promises of outcomes. No invented citations. If you reference a rule or deadline, name the issuing authority in plain text.`
