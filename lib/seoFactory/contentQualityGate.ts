...
export function qualityPromptBlock(contentType?: string): string {
  ...
  return [
    ...
    '',
    'EDITORIAL PASS — apply these together before returning the draft:',
    ...
    '',
    'Q6. NO HYPE. HARD BLOCK. No "act now", "limited time", stacked exclamation marks,',
    '    or superlative bait ("best ever", "ultimate guide").',
    '',
    '━━━ IMPORTANT (warnings — degrade the score; mill/kit/stuffing still rewrite in-desk) ━━━',
    '',
